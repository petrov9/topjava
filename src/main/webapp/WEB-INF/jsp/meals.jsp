...
<div class="jumbotron pt-4">
    <div class="container">
        ...
        <form id="filterForm">
            ...
            <button onclick="filter();return false"><spring:message code="meal.filter"/></button>
            <button type="reset"><spring:message code="meal.resetFilter"/></button>
        </form>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><spring:message code="meal.edit"/></h5>
